...
const Hero = ({ onOpenReservation }) => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-cover bg-center bg-fixed border-b border-alpha-gold/30" style={{ backgroundImage: "url('/backgroundalfa.webp')" }}>
      ...
      {/* Content */}
      <div className="relative z-20 h-full flex items-center justify-center pt-16 md:pt-24">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-2xl text-gray-300 font-light tracking-wide max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col items-center mt-6 mb-36 space-y-2 animate-pulse">
